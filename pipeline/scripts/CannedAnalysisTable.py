...
class CannedAnalysisTable:
    ...
    def load_analyses(self):
        self.analysis_df = self.insert_dataframe(self.annotated_df[['dataset_fk', 'tool_fk', 'canned_analysis_url']], 'canned_analysis', self.connection)
        ...
        self.metadata_df = pd.DataFrame([{'canned_analysis_fk': analysisIdDict[index], 'term_name': variable, 'value': value} for index, metadataDict in self.annotated_df['metadata'].iteritems() for variable, value in metadataDict.iteritems()])
